    ...
    <center class="wrapper" style="display: table;table-layout: fixed;width: 100%;min-width: 620px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #f6f6f8">
      ...
      <div class="spacer" style="font-size: 1px;line-height: 20px;width: 100%">&nbsp;</div>
          ...
          <table class="one-col-bg" style="border-collapse: collapse;border-spacing: 0;width: 100%">
            ...
            <h1 style="font-style: normal;font-weight: 400;Margin-bottom: 18px;Margin-top: 0;font-size: 22px;line-height: 30px;font-family: Ubuntu,sans-serif;color: #b0b0b0">ClientApp&nbsp;/<span style="color:#3e4751"> {{$title}}</span></h1>
            ...
            <p style="font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 0;font-size: 13px;line-height: 22px;font-family: Cabin,Avenir,sans-serif;color: #7c7e7f"><br />
ClientApp</p>
              ...
              <tbody><tr>
                <td style="padding: 0;vertical-align: middle;color: gray;font-size: 12px;line-height: 22px;text-align: left;width: 400px">
                  ...
                  <div class="address" style="font-family: Ubuntu,sans-serif;Margin-bottom: 18px">
                    <div>Naughton & Ross ClientApp.<br />
